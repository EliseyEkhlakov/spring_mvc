...
import com.adorlys.spring.mvc.validation.CheckEmail;
...
public class Employee {
    @Size(min=2, message = "name must be min 2 sym.")
    private String name;
    @NotBlank(message = "must not be blank")
    private String surname;
    @Min(value = 500,message = ">= 499")
    @Max(value = 1000,message = "<= 1001")
    private int salary;
